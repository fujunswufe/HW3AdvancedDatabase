package edu.pitt.infsci2711.recommend;
...
/* for each line of input, generates user pairs that have common friend, or are already friends */
  public static class Map1 extends Mapper<LongWritable, Text, Text, IntWritable> {
    ...
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
      ...
      for(i = 0; i < length; i++) {
        context.write(new Text(user_id + ',' + friends_id.elementAt(i)), zero);
      }
      for(i = 0; i < length; i++) {
        for(j = 0; j < length; j ++) {
          if(j == i)
            continue;
          context.write(new Text(friends_id.elementAt(i) + ',' + friends_id.elementAt(j)), one);
        }
      }
    }
  } 
  ...
  public static void main(String[] args) throws Exception {
    ...
    FileInputFormat.addInputPath(job, new Path("/home/cloudera/workspace/Recommendation/soc-LiveJournal1Adj.txt"));
    FileOutputFormat.setOutputPath(job, new Path("/home/cloudera/workspace/Recommendation/tempData"));
    ...
    FileInputFormat.addInputPath(job2, new Path("/home/cloudera/workspace/Recommendation/tempData"));
    FileOutputFormat.setOutputPath(job2, new Path("/home/cloudera/workspace/Recommendation/Output"));
